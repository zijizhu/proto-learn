...
from .concept_parts import (
    attributes_names,
    id_to_attributes,
    id_to_bbox,
    id_to_part_loc,
    part_attributes_names,
...
def evaluate_concept_trustworthiness(all_activation_maps, all_img_ids, bbox_half_size=36, img_size=224):
    ...
    for attri_idx in tqdm(range(n_attributes)):
        ...
        cal_pred_bboxes, cal_part_locs, _ = pred_bboxes[cal_img_indexes], part_locs[cal_img_indexes], part_exist[cal_img_indexes]  # (n_cal_samples, 4), (n_cal_samples, Np, 2), (n_cal_samples, Np)
